...
curl -X POST   -H "Content-Type: application/json" --data "{\"name\": \"$1\", \"config\": { \"connector.class\": \"io.confluent.connect.elasticsearch.ElasticsearchSinkConnector\", \"tasks.max\": \"1\", \"topics\": \"$ELASTIC_TOPICS\", \"key.ignore\": \"true\", \"schema.ignore\": \"true\", \"connection.url\": \"http://elasticsearch:9200\", \"type.name\": \"test-type\", \"name\": \"elasticsearch-sink\" }}" http://$URL/connectors
\
